...
* **v1.0.6**
  * Added 2 configuration options (Using ConfigManager mod), to toggle Broadcasting in multiple and ignoring incoming multiplayer broadcasts. Thanks to Sean3z!